...
alias ts3pb="AWS_ACCESS_KEY_ID='9V5FWRE0GCYBYGYCB587' AWS_SECRET_ACCESS_KEY='zXWBOd2CRvfr90Hf9CvDhKKPIzBCwrxPYP7q5L3W' S3_USE_HTTPS=0 S3_ENDPOINT=plasticbox-rgw.corp.nuro.team:7480 S3_STAT_CACHE_MAX_AGE=0 TF_CPP_MIN_LOG_LEVEL=3 AWS_REGION=us-west-1 ./bazel-bin/base/file/s3_file_system_test"
alias bts3="bs3 && ts3"
